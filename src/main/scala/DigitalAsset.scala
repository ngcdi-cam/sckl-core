 ...
 // import context._
  ...
  val daBehaviour:Receive = {
    ...
    case StopMessage(ap:String) =>
      ...
      log.debug("RECEIVED STOP MESSAGE!!!!!!===>"+actdel.pathString+"<===>"+self.path.toSerializationFormat+"<====")
...
//  }
  ...
  /*
   * Register this DA with the functionProvisioner
   */
//  override def registerInterestedRole(ref:ActorRef): Unit ={
//      ref ! DARegistration(nodeName)
//  }
